...
public class UserInterface2 extends JFrame implements ActionListener {
	...
	private JTextField textFieldGuess1_3; //used for displaying 
	...
	private JLabel lblTrack1_3 = new JLabel("Track 1");	//label used for showing what tracks are where
	...
	private JLabel lblRange_3 = new JLabel("Range:"); //used to define the range of the tracks
	private JLabel lblAttempts_3 = new JLabel("Attempts:"); //used as a way of informing the player what the numbers above the Jlists are
	private JLabel lblAttemptsDisplay1_3 = new JLabel(""); //used for displaying attempts
	...
	private JLabel lblArrowDisplay1_3 = new JLabel("");	//used for displaying if the number was too high or low
	...
	private JButton btnSubmitGuesses_3 = new JButton("Submit Guesses"); //used to submit guesses
	private JLabel lblGameError = new JLabel(""); //used for displaying game errors
	...
	private void checkNumbers() {
		...
		if (NCM2.getSelectedMode() == 1) {
			...
			if (tracksGuessed == 3) {
				JlistHistory1_1.clearSelection();
				JlistHistory2_1.clearSelection();
				JlistHistory3_1.clearSelection();
		...
		if (NCM2.getSelectedMode() == 2) {
			...
			if (tracksGuessed == 5) {
				JlistHistory1_2.clearSelection();
				JlistHistory2_2.clearSelection();
				JlistHistory3_2.clearSelection();
				JlistHistory4_2.clearSelection();
				JlistHistory5_2.clearSelection();
				allNumbersCorrect = true;
				NCM2.checkTracks(allNumbersCorrect);
				tracksGuessed = 0;
				if (allNumbersCorrect) {
		...
		if (NCM2.getSelectedMode() == 3) {
			...
			if (tracksGuessed == 7) {
				JlistHistory1_3.clearSelection();
				JlistHistory2_3.clearSelection();
				JlistHistory3_3.clearSelection();
				JlistHistory4_3.clearSelection();
				JlistHistory5_3.clearSelection();
				JlistHistory6_3.clearSelection();
				JlistHistory7_3.clearSelection();
				allNumbersCorrect = true;
				NCM2.checkTracks(allNumbersCorrect);
				tracksGuessed = 0;
				if (allNumbersCorrect) {
	...
	private void gameOver() {
		...
		File txtFile = new File("TXT/Scores.txt");	
		  ...
		  try {
	            ...
	            bufferedWriter.write(", " + String.valueOf(NCM2.getScore()));
	            bufferedWriter.write(", " + String.valueOf(NCM2.getLevel()));
	            bufferedWriter.write(" 0-" + String.valueOf(NCM2.getRange()));
